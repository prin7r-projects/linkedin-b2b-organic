...
| Channel | Contribution | Why it fits the audience |
|---|---:|---|
| **Existing-retainer referral** | 40% (≈2.4 of 6) | The audience trusts a peer's signal more than any ad. Most credible source. |
| **The work itself (organic discovery)** | 30% (≈1.8 of 6) | The ghostwritten posts on retainer principals' feeds *are* the marketing. Comment-engine surface area is the discovery surface. |
| **Quiet group chats / Slacks** | 20% (≈1.2 of 6) | Pavilion, GTM Partners, Reforge alumni, Acquired listener Slacks — where ICP already discusses craft. We participate, we never broadcast. |
| **Investor portfolio intros** | 8% (≈0.5 of 6) | A handful of B2B-SaaS-focused funds will introduce portfolio CEOs once we've delivered for one. We do not pay referral fees. |
| **The agency-principal flow** | 2% (≈0.1 of 6) | Two-team retainer (CRO + 3 voices) — rare and lumpy. Sourced through existing CEO retainers upstream-introducing their CRO. |
| Paid LinkedIn ads | 0% | We don't run paid acquisition. Wrong signal for the brand. |
| Paid Google ads | 0% | Wrong intent. People who Google "LinkedIn ghostwriter" are looking for $1k/mo. |

The math is deliberately narrow: at 6 retainers per cohort, we cannot scale acquisition spend without breaking intake. Six is a structural constraint, not a marketing claim.
...
**Average referral conversion.** ~55% from intro to intake call; ~70% from intake to retainer. Much higher than any other channel.

**Failure mode.** A retainer who churns at month-2 may slag us in their network for the next 18 months. We treat onboarding rigour as a referral-channel investment.
...
### 3. Quiet group chats / Slacks (20%)

**Channels we participate in.**
- Pavilion (CRO/Sales-leader community).
- GTM Partners' Discord.
- Reforge alumni Slack (#growth-experiments, #content).
...
**Failure mode.** Slacks moderate self-promotion aggressively. We've been removed from one community in 2025 for what the moderator called "subtle promotion." We accept that risk and don't appeal it.
...
**Conversion.** ~50% of investor-introed intros become a retainer. High because the trust transfer is high.
...
- **Cold outbound DMs to prospective retainers.** We are a ghostwriting agency. We will not pollute our own house.
- **Paid LinkedIn / Google ads.** Wrong signal for the price point and the brand.
- **Sponsored-newsletter placements.** Tested twice in 2025; CAC was 7-9× referral CAC, and the customers churned faster.
- **Affiliate partnerships with LinkedIn coaches.** Coaches have the wrong audience for our price point and our values are misaligned.
- **Conference sponsorships.** Logged interest in 2026 Pavilion CRO Connect; declined the $30k tier; will attend without sponsoring.

## Channel KPIs we track (monthly)

- Cohort fill rate — target 100% (six of six). Below 80% triggers a head-writer review of the comment-engine surface area.
- Referral-conversion ratio — target 55% intro → call, 70% call → retainer. Anything below 30% triggers a review of onboarding rigour.
- Slack participation count — minimum 8/month across the five channels.
- Time-to-first-call after inbound — target ≤ 6 working hours, hard ceiling 24h.
